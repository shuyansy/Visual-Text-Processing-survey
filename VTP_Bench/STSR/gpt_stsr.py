    ...
    messages = [
        {
            "role": "system",
            "content": """
            The image you will receive is composed of two parts: (1) The top section is the original image. (2) The bottom section is generated by a model after image super-resolution. Please evaluate the model’s image super-resolution capabilities based on the following two criteria:
            ...
            (2) Textual Fidelity (Score: 0-5): Firstly recognize the texts in the generated image (the bottom section) and recognize the texts in the original image (the top section). Then, assign a higher score if the words are closely matched.
...
if __name__ == '__main__':
    folder="/STSR_data/tbsrn"
    new_folder="./evaluation_results/tbsrn"
